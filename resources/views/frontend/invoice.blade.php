...
<head>
    ...
    <link href="/invoice/assets/fonts.css" rel="stylesheet" />
                        ...
                        <div class="row justify-content-between my-4">
                            <div class="col-auto">
                                <div class="invoice-left">
                                    ...
                                    @elseif ($orderItems->order->payment_status == 'processing')
                            ...
                            <div class="col-auto">
                                <div class="invoice-right">
                                    ...
                                    <span>Name: {{ $orderItems->order->shipping_first_name }}  {{  $orderItems->order->shipping_last_name }}</span><br>
                                    <span>Email: {{ $orderItems->order->shipping_email }}</span><br>
                                    <span>Phone:  {{ $orderItems->order->shipping_phone }}</span><br>
                                    <span>Address: {{ $orderItems->order->shipping_address }}</span><br>
                                    <span>Country: {{ $orderItems->order->shipping_country  }}</span><br>
                                    <span>City: {{ $orderItems->order->shipping_city }}</span><br>
                                    <span>Zip: {{ $orderItems->order->shipping_postal_code }}</span><br>
                                </div>
                            </div>
                        </div>
