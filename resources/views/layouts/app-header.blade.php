    ...
    <div class="container-fluid main-container">
        <div class="d-flex">
            ...
            <a class="logo-horizontal " href="index.html">
                <img src="/assetss/images/brand/logo-white.png" class="header-brand-img desktop-logo" alt="logo">
                <img src="/assetss/images/brand/logo-dark.png" class="header-brand-img light-logo1" alt="logo">
            </a>
            <!-- LOGO -->
                        ...
                        <div class="d-flex order-lg-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="drop-heading border-bottom">
                                        <div class="d-flex justify-content-between align-items-center">
                                            ...
                                            <a class="btn btn-primary w-sm btn-sm py-2" href="ecommerce-cart.html"><i class="fe fe-shopping-cart"></i> View Cart</a>
                                        </div>
                                    </div>
                                    <div class="header-dropdown-list message-menu">
                                        <div class="dropdown-item d-flex p-4">
                                            ...
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                <img src="/assetss/images/products/3.jpg" alt="">
                                            </span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="ecommerce-cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                <img src="/assetss/images/products/42.jpg" alt="">
                                            </span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="ecommerce-cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                <img src="/assetss/images/products/43.jpg" alt="">
                                            </span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="ecommerce-cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                <img src="/assetss/images/products/44.jpg" alt="">
                                            </span>
                                            <div class="wd-50p">
                                        ...
                                        <div class="dropdown-item d-flex p-4">
                                            <a href="ecommerce-cart.html" class="open-file"></a>
                                            <span class="avatar avatar-xl br-5 me-3 align-self-center cover-image">
                                                <img src="/assetss/images/products/45.jpg" alt="" class="">
                                            </span>
                                            <div class="wd-50p">
                            ...
                            <div class="dropdown  d-flex notifications">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                        ...
                                        <div class="d-flex align-items-start dropdown-item">
                                            <div class="flex-grow-1">
                                                <div class="d-flex align-items-start justify-content-between mb-1">
                                                    ...
                                                    <a href="#" class="text-danger p-0"><i class="fe fe-x"></i></a>
                                                </div>
                                                <a href="" class="p-0 d-flex align-items-end justify-content-between p-12">
                                    ...
                                    <div class="dropdown-divider m-0"></div>
                                    <a href="basic-alert.html" class="dropdown-item text-center p-3 text-muted">View all
                                        Notification</a>
                                </div>
                            </div>
                            <!-- NOTIFICATIONS -->
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="message-menu message-menu-scroll">
                                        <a class="dropdown-item d-flex" href="private-chat.html">
                                            <span class="avatar avatar-md  me-3 align-self-center cover-image">
                                                <img src="/assetss/images/profiles/1.jpg" alt="">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="private-chat.html">
                                            <span class="avatar avatar-md  me-3 align-self-center cover-image">
                                                <img src="/assetss/images/profiles/15.jpg" alt="">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="private-chat.html">
                                            <span class="avatar avatar-md  me-3 align-self-center cover-image">
                                                <img src="/assetss/images/profiles/12.jpg" alt="">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                        ...
                                        <a class="dropdown-item d-flex" href="private-chat.html">
                                            <span class="avatar avatar-md  me-3 align-self-center cover-image">
                                                <img src="/assetss/images/profiles/3.jpg" alt="">
                                            </span>
                                            <div class="wd-90p">
                                                <div class="d-flex">
                                    ...
                                    <div class="dropdown-divider m-0"></div>
                                    <a href="private-chat.html" class="dropdown-item text-center p-3 text-muted">See all
                                        Messages</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown d-flex profile-1">
                                <a href="javascript:void(0)" data-bs-toggle="dropdown" class="nav-link user-dropdown">
                                    <img src="/assetss/images/profiles/5.jpg" alt="profile-user" class="profile-user avatar  cover-image">
                                    <div class="media-body d-lg-block d-none box-col-none ps-2">
                                        <p class="mb-0">Alex Mora</p>
